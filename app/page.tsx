  ...
  return (
    <main id="inicio">
      ...
      <section className="hero section-dark" aria-labelledby="hero-title">
        ...
        <div className="container hero-layout">
          <div className="hero-copy reveal">
            <p className="eyebrow">
              <span /> Evento científico · cultural · 2026
            </p>

            <h1 id="hero-title" className="sr-only">
              XLVI Evento del Químico 2026
            </h1>
            ...
            <div className="hero-actions">
              <a className="button button-primary" href="#programa">
                Explorar programa <ChevronRight size={18} />
              </a>
          ...
          <div className="hero-card-wrap" aria-label="Datos del evento">
            ...
            <article className="glass-card">
              ...
              <p>
                <MapPin size={16} /> {content.event.venue}
              </p>
      ...
      <div className="ticker" aria-label="Ejes del evento">
        <div>
          QUÍMICA <b>✦</b> FORMACIÓN <b>✦</b> PROFESIÓN <b>✦</b> INNOVACIÓN{" "}
          <b>✦</b> COMUNIDAD <b>✦</b> FUTURO
        </div>
      </div>
      ...
      >
        <div className="container">
          <div className="section-heading split-heading">
            <div>
              <p className="section-index">02 — Lo que encontrarás</p>
              <h2 id="event-title">
                Química que evoluciona,
                <br />
                <em>futuro que se construye</em>
              </h2>
            </div>

            <div>
              <p className="lead">{content.overview.intro}</p>
            </div>
          </div>

          <div className="mascot-scene">
            <figure className="mascot-duo">
              <Image
                src="/characters/quantito-matri.jpeg"
                alt="Quantito y Matri, las mascotas del Evento del Químico"
                width={1024}
                height={1024}
                sizes="(max-width: 720px) 92vw, 760px"
              />
              <figcaption className="mascot-names">
                <span>Quantito</span>
                <span>Matri</span>
              </figcaption>
            </figure>
            ...
            <div className="mascot-copy">
              <p>Dos anfitriones curiosos para acompañar esta edición</p>
            </div>
          </div>
      ...
      >
        <div className="container">
          <div className="section-heading program-heading">
            ...
            <p>
              Horarios, sedes y participantes están sujetos a confirmación. Usa
              los filtros para explorar la propuesta de agenda.
            </p>
          </div>
      ...
      >
        <div className="container">
          ...
          <div className="partners-title-row">
            ...
            <p>
              Este espacio está listo para incorporar las identidades aprobadas
        ...
        <div className="container info-grid">
          <div>
            ...
            <p className="info-copy">
              Datos provisionales para orientar a la comunidad. Confirma la
              información antes de difundir.
            </p>
          </div>
